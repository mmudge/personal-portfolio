module ApplicationHelper
  ...
  def source_helper(styles)
    if session[:source]
      greeting = "Thanks for visitng me from #{session[:source]}, please feel free to #{ link_to 'contact me', contact_path} if you would like to work together."
